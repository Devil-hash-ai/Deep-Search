...
if __name__ == "__main__":
    qa_path = "/path/to/WebQA_test_qa.json"
    caption_path = "/path/to/WebQA_caption_test.json"
    index_path = "/path/to/WebQA_test_image_index_to_image_id.json"
    ...
    save_path = os.path.join(save_dir, "processed_webqa.jsonl")
